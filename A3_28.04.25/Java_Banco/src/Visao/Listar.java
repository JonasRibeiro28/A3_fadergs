    ...
    private void initComponents() {
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGap(52, 52, 52)
                .addComponent(Campoimagem, javax.swing.GroupLayout.PREFERRED_SIZE, 188, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(Campoimagem, javax.swing.GroupLayout.PREFERRED_SIZE, 183, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
 ...
 //Selecionar contato   
        ...
        if(linha != -1)
        {
         ...
         Campovalidade.setText((String)tabela.getValueAt(linha, 6)); 
           try {
                ControleContato cc = new ControleContato();
                InputStream is = cc.getImagem(id);
                if (is != null) {
                    BufferedImage img = ImageIO.read(is);
                    ImageIcon icon = new ImageIcon(img);
                    Campoimagem.setIcon(icon);
                } else {
                    // Define um ícone padrão ou limpa o campo da imagem
                    Campoimagem.setIcon(null); // Define como nulo para limpar
                    // Ou define uma imagem padrão:
                    // Campoimagem.setIcon(new ImageIcon(getClass().getResource("/imagens/imagem_padrao.png")));
                }
            } catch (Exception e) {
                JOptionPane.showMessageDialog(null, "Erro ao carregar imagem: (Talvez nao tenha imagem do produto) " + e.getMessage(), "Erro", JOptionPane.ERROR_MESSAGE);
            }
